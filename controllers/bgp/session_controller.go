...
// +kubebuilder:rbac:groups=bgp.equinixmetal.kubeform.com,resources=sessions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bgp.equinixmetal.kubeform.com,resources=sessions/status,verbs=get;update;patch
...
func (r *SessionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &bgpv1alpha1.Session{}); err != nil {
			klog.Error(err, "unable to set up auditor", bgpv1alpha1.Session{}.APIVersion, bgpv1alpha1.Session{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&bgpv1alpha1.Session{}).
