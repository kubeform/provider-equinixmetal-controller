...
// +kubebuilder:rbac:groups=gateway.equinixmetal.kubeform.com,resources=gateways,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=gateway.equinixmetal.kubeform.com,resources=gateways/status,verbs=get;update;patch
...
func (r *GatewayReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &gatewayv1alpha1.Gateway{}); err != nil {
			klog.Error(err, "unable to set up auditor", gatewayv1alpha1.Gateway{}.APIVersion, gatewayv1alpha1.Gateway{}.Kind)
			return err
		}
	}
