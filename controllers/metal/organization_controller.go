...
// +kubebuilder:rbac:groups=metal.equinixmetal.kubeform.com,resources=organizations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=metal.equinixmetal.kubeform.com,resources=organizations/status,verbs=get;update;patch
...
func (r *OrganizationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &metalv1alpha1.Organization{}); err != nil {
			klog.Error(err, "unable to set up auditor", metalv1alpha1.Organization{}.APIVersion, metalv1alpha1.Organization{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&metalv1alpha1.Organization{}).
