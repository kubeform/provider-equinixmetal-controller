...
// +kubebuilder:rbac:groups=metal.equinixmetal.kubeform.com,resources=devices,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=metal.equinixmetal.kubeform.com,resources=devices/status,verbs=get;update;patch
...
func (r *DeviceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &metalv1alpha1.Device{}); err != nil {
			klog.Error(err, "unable to set up auditor", metalv1alpha1.Device{}.APIVersion, metalv1alpha1.Device{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&metalv1alpha1.Device{}).
