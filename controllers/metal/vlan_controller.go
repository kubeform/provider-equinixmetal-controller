...
// +kubebuilder:rbac:groups=metal.equinixmetal.kubeform.com,resources=vlans,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=metal.equinixmetal.kubeform.com,resources=vlans/status,verbs=get;update;patch
...
func (r *VlanReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &metalv1alpha1.Vlan{}); err != nil {
			klog.Error(err, "unable to set up auditor", metalv1alpha1.Vlan{}.APIVersion, metalv1alpha1.Vlan{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&metalv1alpha1.Vlan{}).
