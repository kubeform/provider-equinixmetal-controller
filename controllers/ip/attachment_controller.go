...
// +kubebuilder:rbac:groups=ip.equinixmetal.kubeform.com,resources=attachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ip.equinixmetal.kubeform.com,resources=attachments/status,verbs=get;update;patch
...
func (r *AttachmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ipv1alpha1.Attachment{}); err != nil {
			klog.Error(err, "unable to set up auditor", ipv1alpha1.Attachment{}.APIVersion, ipv1alpha1.Attachment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ipv1alpha1.Attachment{}).
