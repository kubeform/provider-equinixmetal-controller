...
// +kubebuilder:rbac:groups=reserved.equinixmetal.kubeform.com,resources=ipblocks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=reserved.equinixmetal.kubeform.com,resources=ipblocks/status,verbs=get;update;patch
...
func (r *IpBlockReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &reservedv1alpha1.IpBlock{}); err != nil {
			klog.Error(err, "unable to set up auditor", reservedv1alpha1.IpBlock{}.APIVersion, reservedv1alpha1.IpBlock{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&reservedv1alpha1.IpBlock{}).
