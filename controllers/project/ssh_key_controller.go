...
// +kubebuilder:rbac:groups=project.equinixmetal.kubeform.com,resources=sshkeys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=project.equinixmetal.kubeform.com,resources=sshkeys/status,verbs=get;update;patch
...
func (r *SshKeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &projectv1alpha1.SshKey{}); err != nil {
			klog.Error(err, "unable to set up auditor", projectv1alpha1.SshKey{}.APIVersion, projectv1alpha1.SshKey{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&projectv1alpha1.SshKey{}).
