...
// +kubebuilder:rbac:groups=project.equinixmetal.kubeform.com,resources=apikeys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=project.equinixmetal.kubeform.com,resources=apikeys/status,verbs=get;update;patch
...
func (r *ApiKeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &projectv1alpha1.ApiKey{}); err != nil {
			klog.Error(err, "unable to set up auditor", projectv1alpha1.ApiKey{}.APIVersion, projectv1alpha1.ApiKey{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&projectv1alpha1.ApiKey{}).
...
func (r *ApiKeyReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &projectv1alpha1.ApiKeyList{}
