...
// +kubebuilder:rbac:groups=project.equinixmetal.kubeform.com,resources=projects,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=project.equinixmetal.kubeform.com,resources=projects/status,verbs=get;update;patch
...
func (r *ProjectReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &projectv1alpha1.ProjectList{}
