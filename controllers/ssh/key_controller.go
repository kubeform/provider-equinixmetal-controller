...
// +kubebuilder:rbac:groups=ssh.equinixmetal.kubeform.com,resources=keys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ssh.equinixmetal.kubeform.com,resources=keys/status,verbs=get;update;patch
