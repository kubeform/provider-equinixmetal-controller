...
// +kubebuilder:rbac:groups=device.equinixmetal.kubeform.com,resources=devices,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=device.equinixmetal.kubeform.com,resources=devices/status,verbs=get;update;patch
...
func (r *DeviceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &devicev1alpha1.Device{}); err != nil {
			klog.Error(err, "unable to set up auditor", devicev1alpha1.Device{}.APIVersion, devicev1alpha1.Device{}.Kind)
			return err
		}
	}
...
func (r *DeviceReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Device")
			return nil
		}
		...
		resourceList := &devicev1alpha1.DeviceList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Device")
			return nil
		}
