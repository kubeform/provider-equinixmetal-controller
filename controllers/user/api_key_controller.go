...
// +kubebuilder:rbac:groups=user.equinixmetal.kubeform.com,resources=apikeys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=user.equinixmetal.kubeform.com,resources=apikeys/status,verbs=get;update;patch
...
func (r *ApiKeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &userv1alpha1.ApiKey{}); err != nil {
			klog.Error(err, "unable to set up auditor", userv1alpha1.ApiKey{}.APIVersion, userv1alpha1.ApiKey{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&userv1alpha1.ApiKey{}).
...
func (r *ApiKeyReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &userv1alpha1.ApiKeyList{}
