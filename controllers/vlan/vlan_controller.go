...
// +kubebuilder:rbac:groups=vlan.equinixmetal.kubeform.com,resources=vlans,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=vlan.equinixmetal.kubeform.com,resources=vlans/status,verbs=get;update;patch
...
func (r *VlanReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &vlanv1alpha1.Vlan{}); err != nil {
			klog.Error(err, "unable to set up auditor", vlanv1alpha1.Vlan{}.APIVersion, vlanv1alpha1.Vlan{}.Kind)
			return err
		}
	}
