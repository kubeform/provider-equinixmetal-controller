...
// +kubebuilder:rbac:groups=volume.equinixmetal.kubeform.com,resources=attachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=volume.equinixmetal.kubeform.com,resources=attachments/status,verbs=get;update;patch
