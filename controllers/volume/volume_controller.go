...
// +kubebuilder:rbac:groups=volume.equinixmetal.kubeform.com,resources=volumes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=volume.equinixmetal.kubeform.com,resources=volumes/status,verbs=get;update;patch
