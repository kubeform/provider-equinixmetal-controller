module kubeform.dev/provider-equinixmetal-controller
...
require (
	...
	kubeform.dev/provider-equinixmetal-api v0.4.1-0.20220308121011-90214aac2f6d
...
require (
	...
	github.com/packethost/packngo v0.22.0 // indirect
