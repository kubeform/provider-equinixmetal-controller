...
import (
	...
	equinixmetalscheme "kubeform.dev/provider-equinixmetal-api/client/clientset/versioned/scheme"
...
func init() {
	_ = equinixmetalscheme.AddToScheme(scheme)
...
func NewCmdRun(version string) *cobra.Command {
	cmd := &cobra.Command{
		Use:               "run",
		Short:             "Launch Kubeform equinixmetal Provider controller",
		DisableAutoGenTag: true,
		Run: func(cmd *cobra.Command, args []string) {
			klog.Infoln("Starting provider-equinixmetal-controller...")
			...
			mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
				...
				LeaderElectionID:       "equinixmetal.kubeform.com",
			})
			if err != nil {
