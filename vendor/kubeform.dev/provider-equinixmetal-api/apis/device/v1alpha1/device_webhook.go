...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-device-equinixmetal-kubeform-com-v1alpha1-device,mutating=false,failurePolicy=fail,groups=device.equinixmetal.kubeform.com,resources=devices,versions=v1alpha1,name=device.device.equinixmetal.kubeform.io,sideEffects=None,admissionReviewVersions=v1
...
var deviceForceNewList = map[string]bool{
	"/billing_cycle":           true,
	"/facilities":              true,
	"/hardware_reservation_id": true,
	"/metro":                   true,
	"/operating_system":        true,
	"/plan":                    true,
	"/project_id":              true,
	"/project_ssh_key_ids":     true,
	"/storage":                 true,
}
