...
type ReservedIPBlock struct {
	...
	Spec              ReservedIPBlockSpec   `json:"spec,omitempty"`
	Status            ReservedIPBlockStatus `json:"status,omitempty"`
}

type ReservedIPBlockSpec struct {
	State *ReservedIPBlockSpecResource `json:"state,omitempty" tf:"-"`

	Resource ReservedIPBlockSpecResource `json:"resource" tf:"resource"`
...
type ReservedIPBlockSpecResource struct {
...
// ReservedIPBlockList is a list of ReservedIPBlocks
type ReservedIPBlockList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of ReservedIPBlock CRD objects
	Items []ReservedIPBlock `json:"items,omitempty"`
}
