...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-metal-equinixmetal-kubeform-com-v1alpha1-device,mutating=false,failurePolicy=fail,groups=metal.equinixmetal.kubeform.com,resources=devices,versions=v1alpha1,name=device.metal.equinixmetal.kubeform.io,sideEffects=None,admissionReviewVersions=v1
