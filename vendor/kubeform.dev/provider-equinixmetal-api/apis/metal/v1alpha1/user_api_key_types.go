...
type UserAPIKey struct {
	...
	Spec              UserAPIKeySpec   `json:"spec,omitempty"`
	Status            UserAPIKeyStatus `json:"status,omitempty"`
}

type UserAPIKeySpec struct {
	State *UserAPIKeySpecResource `json:"state,omitempty" tf:"-"`

	Resource UserAPIKeySpecResource `json:"resource" tf:"resource"`
...
type UserAPIKeySpecResource struct {
...
// UserAPIKeyList is a list of UserAPIKeys
type UserAPIKeyList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of UserAPIKey CRD objects
