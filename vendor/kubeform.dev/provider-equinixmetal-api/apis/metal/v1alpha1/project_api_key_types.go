...
type ProjectAPIKey struct {
	...
	Spec              ProjectAPIKeySpec   `json:"spec,omitempty"`
	Status            ProjectAPIKeyStatus `json:"status,omitempty"`
}

type ProjectAPIKeySpec struct {
	State *ProjectAPIKeySpecResource `json:"state,omitempty" tf:"-"`

	Resource ProjectAPIKeySpecResource `json:"resource" tf:"resource"`
...
type ProjectAPIKeySpecResource struct {
...
// ProjectAPIKeyList is a list of ProjectAPIKeys
type ProjectAPIKeyList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of ProjectAPIKey CRD objects
	Items []ProjectAPIKey `json:"items,omitempty"`
}
